...
async function main() {
    ...
    try {
        // Load templates
        const modelTemplateSource = await fs.readFile(path.resolve(__dirname, './src/generators/model-template.handlebars'), 'utf-8');
        const indexTemplateSource = await fs.readFile(path.resolve(__dirname, './src/generators/index-template.handlebars'), 'utf-8');
